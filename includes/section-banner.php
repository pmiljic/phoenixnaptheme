...
<section class="banner" style=" background-color: orange">
    <div class="container">
        ...
        <?php if (sizeof($slides) > 0) : ?>
            <div id="slides" class="row carousel slide img-fluid" data-ride="carousel">
                ...
                <div class="carousel-inner col-md-12 col-lg-6 banner__left-div">
                    ...
                    <?php foreach ($slides as $slide) : ?>
                        ...
                        <div class="carousel-item <?php echo $carousel_item_active ?>" style="background-image: url(<?php echo esc_url($slide['photo']) ?>)">
                            <!-- <img src=<?php echo esc_url($slide['photo']) ?>> -->
                ...
                <div class="col-md-12 col-lg-6 d-flex flex-column justify-content-end">
                    <div class="d-flex">
                    ...
                    <div class="video">
                        <a href="#"><strong><?php esc_html_e('Play video', 'phoenixnaptheme') ?></strong><?php esc_html_e('(3min)', 'phoenixnaptheme') ?></a>
